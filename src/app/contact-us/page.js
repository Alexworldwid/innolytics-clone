const Contact = () => {
    return ( 
        <section id="sect-1" className="flex flex-col items-center bg-gray-200 p-4 rounded-lg min-w mt-16">
                <h1 className="text-5xl font-bold mb-4 text-center leading-normal md:text-left">Coming Soon</h1>
